...
function displayExhibitions(exhibitionList) {
  const html = exhibitionList
    .map((item) => {
      // her opbygger vi et nyt array, med map () baseret på vores exhibition-array

      // her opbygger vi vores HTML-streng (HTML Struktur)
    ...
    .join(""); //her samler vi det hele med join(""), til en samlet HTML-streng.
